...
class EdsBootstrap_Admin {
	...
	public static function hide_notices() {
		if ( isset( $_GET['edsbootstrap-hide-notice'] ) && isset( $_GET['_edsbootstrap_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_edsbootstrap_notice_nonce'], 'edsbootstrap_hide_notices_nonce' ) ) {
				wp_die( __( 'Action failed. Please refresh the page and retry.', 'edsbootstrap' ) );
			}

			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( __( 'Cheatin&#8217; huh?', 'edsbootstrap' ) );
			}

			$hide_notice = sanitize_text_field( $_GET['edsbootstrap-hide-notice'] );
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated cresta-message">
			<a class="cresta-message-close notice-dismiss" href="<?php echo esc_url( wp_nonce_url( remove_query_arg( array( 'activated' ), add_query_arg( 'edsbootstrap-hide-notice', 'welcome' ) ), 'edsbootstrap_hide_notices_nonce', '_edsbootstrap_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss', 'edsbootstrap' ); ?></a>
			<p><?php printf( esc_html__( 'Welcome! Thank you for choosing edsbootstrap! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'edsbootstrap' ), '<a href="' . esc_url( admin_url( 'themes.php?page=edsbootstrap-welcome' ) ) . '">', '</a>' ); ?></p>
			<p class="submit">
	...
	private function intro() {
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					<a href="<?php echo esc_url( 'http://crestaproject.com/downloads/edsbootstrap' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'edsbootstrap' ); ?></a>

					<a href="<?php echo esc_url( apply_filters( 'edsbootstrap_pro_theme_url', 'http://crestaproject.com/demo/edsbootstrap/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'edsbootstrap' ); ?></a>

					<a href="<?php echo esc_url( apply_filters( 'edsbootstrap_pro_theme_url', 'http://crestaproject.com/demo/edsbootstrap-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'edsbootstrap' ); ?></a>
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'edsbootstrap-welcome' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'edsbootstrap-welcome' ), 'themes.php' ) ) ); ?>">
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'edsbootstrap' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a target="_blank" href="<?php echo esc_url( 'http://crestaproject.com/downloads/edsbootstrap/' ); ?>" class="button button-secondary"><?php esc_html_e( 'Info about PRO version', 'edsbootstrap' ); ?></a></p>
					</div>
			...
			<table>
				<thead>
					<tr>
						...
						<th><h3><?php esc_html_e('edsbootstrap', 'edsbootstrap'); ?></h3></th>
						<th><h3><?php esc_html_e('edsbootstrap PRO', 'edsbootstrap'); ?></h3></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td><h3><?php esc_html_e('Flash News on top', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-yes"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
					...
					<tr>
						<td><h3><?php esc_html_e('Choose Social Incons', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-yes"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('RTL Support', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-yes"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Powerful theme options', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                    <tr>
						<td><h3><?php esc_html_e('4 Blog Style', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                     <tr>
						<td><h3><?php esc_html_e('Portfolio Module', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                    <tr>
						<td><h3><?php esc_html_e('Project Module', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
                     <tr>
						<td><h3><?php esc_html_e('Gallery Module', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('WooCommerce Style', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Posts Slider', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Choose sidebar position', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Footer Widgets', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Stick menu with logo', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('Loading Page', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
					...
					<tr>
						<td><h3><?php esc_html_e('Post views counter', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('8 Shortcodes', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						<td><h3><?php esc_html_e('11 Exclusive Widgets', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
					...
					<tr>
						<td><h3><?php esc_html_e('Information About Author Box', 'edsbootstrap'); ?></h3></td>
						<td><span class="dashicons dashicons-no"></span></td>
						<td><span class="dashicons dashicons-yes"></span></td>
					</tr>
					<tr>
						...
						<td class="btn-wrapper">
							<a href="<?php echo esc_url( apply_filters( 'edsbootstrap_pro_theme_url', 'http://crestaproject.com/demo/edsbootstrap-pro/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View PRO version demo', 'edsbootstrap' ); ?></a>
							<a href="<?php echo esc_url( apply_filters( 'edsbootstrap_pro_theme_url', 'http://crestaproject.com/downloads/edsbootstrap/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'More Information', 'edsbootstrap' ); ?></a>
						</td>
					</tr>
				</tbody>
			</table>
